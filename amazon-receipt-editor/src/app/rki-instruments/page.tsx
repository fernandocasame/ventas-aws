  ...
  const handleDownloadPdf = () => {
    ...
    if (input) {
      html2canvas(input, { scale: 2 }).then(canvas => {
        ...
        pdf.save('rki-instruments-invoice.pdf');
      });
    }
  };
    ...
    <div>
      <div ref={receiptRef} className="bg-white p-8 max-w-4xl mx-auto font-sans text-xs text-gray-800 border">
        ...
        <main>
          ...
          <button onClick={handleAddItem} className="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-3 rounded text-xs mb-4">Add Item</button>
