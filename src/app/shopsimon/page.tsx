    ...
    return (
      ...
      `}</style>
            <div ref={receiptRef} className="bg-white p-4 sm:p-8 max-w-5xl mx-auto font-sans text-sm text-gray-800">
                ...
                <main className="flex">
                    ...
                    <section className="w-3/4">
                        ...
                        <button onClick={handleAddItem} className="mt-4 bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-3 rounded text-sm no-print">Add Item</button>
            ...
            <div className="text-center my-8">
                <button onClick={handleDownloadPdf} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 no-print rounded">
                    Download as PDF
                </button>
            </div>
        </div>
